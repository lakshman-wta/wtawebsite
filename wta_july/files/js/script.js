...
(function() {
    ...
    function isotopeLoadMore(grid, el, url, datas) {
        ...
        var addData = '';
        if (datas) { addData = { action: 'sr_load_more', o: datas }; }
        jQuery.ajax({
    ...
    jQuery(window).load(function() {
        ...
        setTimeout(function() {
            ...
            if (window.location.hash) {
                ...
                if (jQuery('.filter li a[data-slug=' + filter + ']').length > 0) {
                    /*setTimeout(function(){ */
                    jQuery('.filter li a[data-slug=' + filter + ']').trigger("click"); /* }, 500);*/
                }
            }
        ...
        if (jQuery().isotope) {
            ...
            loadMore.click(function() {
                var el = jQuery(this);
                if (el.data("loadpage") === undefined) { el.data("loadpage", "2"); } else { el.data("loadpage", parseInt(el.data("loadpage"), 10) + 1); }
        ...
        if (jQuery().stick_in_parent) {
            setTimeout(function() {
                ...
                if (jQuery("header").hasClass("not-sticky") && !jQuery("header").hasClass("transparent")) { stickyOffset = jQuery("header").height() + 25; } else if (jQuery("header").hasClass("wrapper") && jQuery("header").hasClass("transparent")) { stickyOffset = jQuery("header").height(); }
    ...
    jQuery(document).ready(function() {
        ...
        if (jQuery(".dribbble-widget").length > 0) {
            jQuery('.dribbble-widget').each(function() {
                ...
                if (dribbbleToken) { jQuery.jribbble.setToken(dribbbleToken); } else { jQuery.jribbble.setToken("YOUR CLIENT ACCESS TOKEN"); }
